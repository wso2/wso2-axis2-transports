...
public class OracleAQAxisTestClientConfigurator implements AxisTestClientConfigurator {
    private final String jmsMessageType;
    
    public OracleAQAxisTestClientConfigurator(String jmsMessageType) {
        this.jmsMessageType = jmsMessageType;
    }

    @Key(OracleAQConstants.JMS_MESSAGE_TYPE)
    public String getJmsMessageType() {
        return jmsMessageType;
    }

    public void setupRequestMessageContext(MessageContext msgContext) throws AxisFault {
        msgContext.setProperty(OracleAQConstants.JMS_MESSAGE_TYPE, jmsMessageType);
    }
}
