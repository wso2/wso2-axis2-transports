...
public class OracleAQRequestResponseChannel extends OracleAQChannel implements RequestResponseChannel, AxisTestClientConfigurator {
    ...
    public OracleAQRequestResponseChannel(String name, String destinationType, String replyDestinationType, ContentTypeMode contentTypeMode) {
        super(name, destinationType, contentTypeMode);
        this.replyDestinationType = replyDestinationType;
    }
    
    public OracleAQRequestResponseChannel(String destinationType, String replyDestinationType, ContentTypeMode contentTypeMode) {
        this(null, destinationType, replyDestinationType, contentTypeMode);
    }
    
    @Setup @SuppressWarnings("unused")
    private void setUp(OracleAQTestEnvironment env) throws Exception {
    ...
    public void setupService(AxisService service, boolean isClientSide) throws Exception {
        ...
        service.addParameter(OracleAQConstants.PARAM_REPLY_DEST_TYPE, replyDestinationType);
        service.addParameter(OracleAQConstants.PARAM_REPLY_DESTINATION, replyJndiName);
    }

    public void setupRequestMessageContext(MessageContext msgContext) {
//        msgContext.setProperty(OracleAQConstants.JMS_REPLY_TO, replyDestinationName);
    }

    @Override
    public EndpointReference getEndpointReference() throws Exception {
        String address = super.getEndpointReference().getAddress();
        return new EndpointReference(address + "&" + OracleAQConstants.PARAM_REPLY_DEST_TYPE + "=" + replyDestinationType + "&" + OracleAQConstants.PARAM_REPLY_DESTINATION + "=" + replyJndiName);
    }
