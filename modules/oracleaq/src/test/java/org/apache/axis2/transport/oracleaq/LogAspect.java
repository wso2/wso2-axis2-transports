...
public class LogAspect {
    ...
    @Before("(call(void javax.oracleaq.MessageProducer.send(javax.oracleaq.Message)) ||" +
    		" call(void javax.oracleaq.TopicPublisher.publish(javax.oracleaq.Message))) && args(message)")
    public void beforeSend(Message message) {
        try {
            OutputStream out = LogManager.INSTANCE.createLog("oracleaq");
            try {
