...
@Name("oracleaq")
public class OracleAQClient<T> implements TestClient {
    protected final OracleAQMessageFactory<T> oracleAQMessageFactory;
    ...
    public OracleAQClient(OracleAQMessageFactory<T> oracleAQMessageFactory) {
        this.oracleAQMessageFactory = oracleAQMessageFactory;
    }

    @Named
    public OracleAQMessageFactory<T> getOracleAQMessageFactory() {
        return oracleAQMessageFactory;
    }

    @Setup @SuppressWarnings("unused")
    private void setUp(OracleAQTestEnvironment env, OracleAQChannel channel) throws Exception {
    ...
    protected String doSendMessage(ClientOptions options, ContentType contentType, T message) throws Exception {
        Message jmsMessage = oracleAQMessageFactory.createMessage(session, message);
