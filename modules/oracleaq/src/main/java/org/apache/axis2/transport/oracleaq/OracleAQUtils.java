 ...
 */
public class OracleAQUtils extends BaseUtils {

    private static final Log log = LogFactory.getLog(OracleAQUtils.class);
    ...
    public static boolean isJMSService(AxisService service) {
        if (service.isEnableAllTransports()) {
            ...
            for (String transport : service.getExposedTransports()) {
                if (OracleAQListener.TRANSPORT_NAME.equals(transport)) {
                    return true;
                }
            }
        }
    ...
    public static String getDestination(String url) {
        String tempUrl = url.substring(OracleAQConstants.JMS_PREFIX.length());
     ...
     * @throws JMSException
     */
    public static void setSOAPEnvelope(AdtMessage message, MessageContext msgContext, String contentType)
        ...
        if (message instanceof BytesMessage) {
            ...
            try {
                xml = (((XMLType) message.getAdtPayload()).getStringVal());
            } catch (SQLException e) {
                log.error(e);
            }

            try {
                documentElement = AXIOMUtil.stringToOM(xml);
    ...
    public static OMElement convertJMSMapToXML(MapMessage message) {
        ...
        OMNamespace jmsMapNS = OMAbstractFactory.getOMFactory().createOMNamespace(OracleAQConstants.JMS_MAP_NS, "");
        OMElement jmsMap = fac.createOMElement(OracleAQConstants.JMS_MAP_ELEMENT_NAME, jmsMapNS);
        try {
     ...
     */
    public static void setTransportHeaders(MessageContext msgContext, AdtMessage message)
            throws JMSException {
        ...
        for (Object headerName : headerMap.keySet()) {
            ...
            if (name.startsWith(OracleAQConstants.JMSX_PREFIX) &&
                    !(name.equals(OracleAQConstants.JMSX_GROUP_ID) || name.equals(OracleAQConstants.JMSX_GROUP_SEQ))) {
                continue;
            }

            if (OracleAQConstants.JMS_COORELATION_ID.equals(name)) {
                message.setJMSCorrelationID(
                        (String) headerMap.get(OracleAQConstants.JMS_COORELATION_ID));
            } else if (OracleAQConstants.JMS_DELIVERY_MODE.equals(name)) {
                Object o = headerMap.get(OracleAQConstants.JMS_DELIVERY_MODE);
            ...
            } else if (OracleAQConstants.JMS_EXPIRATION.equals(name)) {
                message.setJMSExpiration(
                        Long.parseLong((String) headerMap.get(OracleAQConstants.JMS_EXPIRATION)));
            } else if (OracleAQConstants.JMS_MESSAGE_ID.equals(name)) {
                message.setJMSMessageID((String) headerMap.get(OracleAQConstants.JMS_MESSAGE_ID));
            } else if (OracleAQConstants.JMS_PRIORITY.equals(name)) {
                message.setJMSPriority(
                        Integer.parseInt((String) headerMap.get(OracleAQConstants.JMS_PRIORITY)));
            } else if (OracleAQConstants.JMS_TIMESTAMP.equals(name)) {
                message.setJMSTimestamp(
                        Long.parseLong((String) headerMap.get(OracleAQConstants.JMS_TIMESTAMP)));
            } else if (OracleAQConstants.JMS_MESSAGE_TYPE.equals(name)) {
                message.setJMSType((String) headerMap.get(OracleAQConstants.JMS_MESSAGE_TYPE));
    ...
    private static String transformHyphenatedString(String name) {
        return name.replaceAll("-", OracleAQConstants.HYPHEN_REPLACEMENT_STR);
    }
    ...
    private static boolean isHyphenReplaceMode(MessageContext msgContext) {
        ...
        String hyphenSupport = (String) msgContext.getProperty(OracleAQConstants.PARAM_JMS_HYPHEN_MODE);
        if (hyphenSupport != null && hyphenSupport.equals(OracleAQConstants.HYPHEN_MODE_REPLACE)) {
            return true;
        }
    ...
    private static boolean isHyphenDeleteMode(MessageContext msgContext) {
        ...
        String hyphenSupport = (String) msgContext.getProperty(OracleAQConstants.PARAM_JMS_HYPHEN_MODE);
        if (hyphenSupport != null && hyphenSupport.equals(OracleAQConstants.HYPHEN_MODE_DELETE)) {
            return true;
        }
     ...
     */
    public static void loadTransportHeaders(AdtMessage message, MessageContext responseMsgCtx)
            throws AxisFault {
        responseMsgCtx.setProperty(MessageContext.TRANSPORT_HEADERS, getTransportHeaders(message, responseMsgCtx));
    }


    public static Map<String, Object> getTransportHeaders(AdtMessage message) {
     ...
     */
    public static Map<String, Object> getTransportHeaders(AdtMessage message, MessageContext msgContext) {
        ...
        try {
            if (message.getJMSCorrelationID() != null) {
                map.put(OracleAQConstants.JMS_COORELATION_ID, message.getJMSCorrelationID());
            }
        } catch (JMSException ignore) {
        }
        ...
        try {
            map.put(OracleAQConstants.JMS_DELIVERY_MODE, Integer.toString(message.getJMSDeliveryMode()));
        } catch (JMSException ignore) {
        }
        ...
        try {
            if (message.getJMSDestination() != null) {
                ...
                map.put(OracleAQConstants.JMS_DESTINATION,
        ...
        // expiration
        try {
            map.put(OracleAQConstants.JMS_EXPIRATION, Long.toString(message.getJMSExpiration()));
        } catch (JMSException ignore) {
        }
        ...
        try {
            if (message.getJMSMessageID() != null) {
                map.put(OracleAQConstants.JMS_MESSAGE_ID, message.getJMSMessageID());
            }
        } catch (JMSException ignore) {
        }
        ...
        // priority
        try {
            map.put(OracleAQConstants.JMS_PRIORITY, Long.toString(message.getJMSPriority()));
        } catch (JMSException ignore) {
        }

        // redelivered
        try {
            map.put(OracleAQConstants.JMS_REDELIVERED, Boolean.toString(message.getJMSRedelivered()));
        } catch (JMSException ignore) {
        }
        ...
        try {
            if (message.getJMSReplyTo() != null) {
                ...
                map.put(OracleAQConstants.JMS_REPLY_TO,
                        dest instanceof Queue ?
                                ((Queue) dest).getQueueName() : ((Topic) dest).getTopicName());
            }
        } catch (JMSException ignore) {
        ...
        // priority
        try {
            map.put(OracleAQConstants.JMS_TIMESTAMP, Long.toString(message.getJMSTimestamp()));
        } catch (JMSException ignore) {
        }
        ...
        try {
            if (message.getJMSType() != null) {
                map.put(OracleAQConstants.JMS_TYPE, message.getJMSType());
            }
        } catch (JMSException ignore) {
        }
     ...
     * @throws JMSException
     */
    public static long getMessageSize(AdtMessage message) throws JMSException {
        if (message instanceof BytesMessage) {
            return OracleAQUtils.getBodyLength((BytesMessage) message);
        } else if (message instanceof TextMessage) {
            ...
            return OracleAQUtils.getBodyLength((MapMessage) message);
        } else if (message instanceof AQjmsAdtMessage) {
            return (message.getAdtPayload().toString()).getBytes().length;
        } else {
    ...
    public static Connection createConnection(ConnectionFactory conFac,
                                              ...
                                              boolean isDurable,
                                              String clientID,
                                              boolean isSharedSubscription) throws JMSException {
        ...
        try {
            if (OracleAQConstants.JMS_SPEC_VERSION_1_1.equals(jmsSpec) || OracleAQConstants.JMS_SPEC_VERSION_2_0.equals(jmsSpec)
                    || isQueue == null) {
                log.info("Creating Topic or Queue: " + conFac.toString());
                if (user != null && pass != null) {
                    log.info("Creating Connection user/pass: " + user + "/" + pass);
                    connection = conFac.createConnection(user, pass);
                } else {
                    log.info("Creating Connection: " + conFac);
                ...
                if (isQueue) {
                    log.info("Creating a Queue Connection: " + clientID);
                    qConFac = (QueueConnectionFactory) conFac;
                } else {
                    log.info("Creating a Topic Connection: " + clientID);
                ...
                if (isDurable) {
                    log.info("Setting the Client ID: " + clientID);
                    connection.setClientID(clientID);
                }
            }
            ...
            if (connection != null) {
                try {
                    log.error("JMS Close connection");
                    connection.close();
                } catch (Exception e) {
                    log.error("Error to close connection: " + e);
                }
            }
            log.error("Error to create connection: " + je);
            throw je;
        }
     ...
     * @throws JMSException on errors, to be handled and logged by the caller
     */
    public static AQjmsSession createSession(Connection connection, boolean transacted, int ackMode,
                                             String jmsSpec, Boolean isQueue) throws JMSException {

        if (OracleAQConstants.JMS_SPEC_VERSION_1_1.equals(jmsSpec) || OracleAQConstants.JMS_SPEC_VERSION_2_0.equals(jmsSpec)
                || isQueue == null) {
            return (AQjmsSession) connection.createSession(transacted, ackMode);

        } else {
            if (isQueue) {
                return (AQjmsSession) ((QueueConnection) connection).createQueueSession(transacted, ackMode);
            } else {
                return (AQjmsSession) ((TopicConnection) connection).createTopicSession(transacted, ackMode);
            }
        }
    }
    ...
    public static MessageConsumer createConsumer(
            AQjmsSession session, Destination destination, Boolean isQueue,
        ...
        if ((OracleAQConstants.JMS_SPEC_VERSION_1_1.equals(jmsSpec)) || (
                OracleAQConstants.JMS_SPEC_VERSION_2_0.equals(jmsSpec) && !isSharedSubscription)) {
            if (isDurable) {
                log.info("JMS Spec version 2.0 or 1.1 and durable.");
                return session.createDurableSubscriber((Topic) destination, subscriberName, messageSelector, pubSubNoLocal, XMLType.getORADataFactory());
            } else {
                log.info("JMS Spec versio 2.0 or 1.1 not durable.");
                return session.createSubscriber((Topic) destination, messageSelector, pubSubNoLocal);
            }
        } else {
            if (isQueue) {
                log.info("JMS is Queue.");
                return ((QueueSession) session).createReceiver((Queue) destination, messageSelector);
            } else {
                if (isDurable) {
                    log.info("JMS is Topic and durable.");
                    return session.createDurableSubscriber((Topic) destination, subscriberName, messageSelector, pubSubNoLocal, XMLType.getORADataFactory());
                } else {
                    log.info("JMS is Topic not durable.");
                    return session.createSubscriber((Topic) destination, messageSelector, pubSubNoLocal);
                }
            }
        }
    ...
    public static String getDestinationTypeAsString(int destType) {
        if (destType == OracleAQConstants.QUEUE) {
            return "queue";
        } else if (destType == OracleAQConstants.TOPIC) {
            return "topic";
        } else {
            return "generic";
        }
    ...
    public static Destination lookupDestination(Context context, String destinationName,
        ...
        try {
            return OracleAQUtils.lookup(context, Destination.class, destinationName);
        } catch (NameNotFoundException e) {
            try {
                Properties initialContextProperties = new Properties();
                if (context.getEnvironment() != null) {
                    if (context.getEnvironment().get(OracleAQConstants.NAMING_FACTORY_INITIAL) != null) {
                        initialContextProperties.put(OracleAQConstants.NAMING_FACTORY_INITIAL, context.getEnvironment().get(OracleAQConstants.NAMING_FACTORY_INITIAL));
                    }
                    if (context.getEnvironment().get(OracleAQConstants.CONNECTION_STRING) != null) {
                        initialContextProperties.put(OracleAQConstants.CONNECTION_STRING, context.getEnvironment().get(OracleAQConstants.CONNECTION_STRING));
                    }
                    if (context.getEnvironment().get(OracleAQConstants.PROVIDER_URL) != null) {
                        initialContextProperties.put(OracleAQConstants.PROVIDER_URL, context.getEnvironment().get(OracleAQConstants.PROVIDER_URL));
                    }
                }
                if (OracleAQConstants.DESTINATION_TYPE_TOPIC.equalsIgnoreCase(destinationType)) {
                    initialContextProperties.put(OracleAQConstants.TOPIC_PREFIX + destinationName, destinationName);
                } else if (OracleAQConstants.DESTINATION_TYPE_QUEUE.equalsIgnoreCase(destinationType)
                        || OracleAQConstants.DESTINATION_TYPE_GENERIC.equalsIgnoreCase(destinationType)) {
                    initialContextProperties.put(OracleAQConstants.QUEUE_PREFIX + destinationName, destinationName);
                }
                InitialContext initialContext = new InitialContext(initialContextProperties);
                try {
                    return OracleAQUtils.lookup(initialContext, Destination.class, destinationName);
                } catch (NamingException e1) {
                    return OracleAQUtils.lookup(context, Destination.class,
                            (OracleAQConstants.DESTINATION_TYPE_TOPIC.equalsIgnoreCase(destinationType) ?
    ...
    public static Hashtable<String, String> maskAxis2ConfigSensitiveParameters(
        ...
        if (maskedParamsTable.get(OracleAQConstants.PARAM_JMS_PASSWORD) != null) {
            maskedParamsTable.put(OracleAQConstants.PARAM_JMS_PASSWORD, MASKING_STRING);
        }
        if (sensitiveParamsTable.get(OracleAQConstants.PARAM_NAMING_SECURITY_CREDENTIALS) != null) {
            maskedParamsTable.put(OracleAQConstants.PARAM_NAMING_SECURITY_CREDENTIALS, MASKING_STRING);
        }
