...
public class OracleAQRequestResponseClient<T> extends OracleAQClient<T> implements RequestResponseTestClient<T,T> {
    ...
    public OracleAQRequestResponseClient(OracleAQMessageFactory<T> oracleAQMessageFactory) {
        super(oracleAQMessageFactory);
    }
    
    @Setup @SuppressWarnings("unused")
    private void setUp(OracleAQTestEnvironment env, OracleAQRequestResponseChannel channel) throws Exception {
    ...
    public IncomingMessage<T> sendMessage(ClientOptions options, ContentType contentType, T message) throws Exception {
        ...
        try {
            ...
            return new IncomingMessage<T>(new ContentType(replyMessage.getStringProperty("Content-Type")),
                                          oracleAQMessageFactory.parseMessage(replyMessage));
        } finally {
            consumer.close();
        }
    }
