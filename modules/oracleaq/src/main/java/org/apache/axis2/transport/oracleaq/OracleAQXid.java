...
public class OracleAQXid implements Xid {
    ...
    public static String toBase64String(final Xid xid) {
        return Base64.encodeBytes(OracleAQXid.toByteArray(xid));
    }
     ...
     */
    public OracleAQXid(final byte[] branchQualifier, final int formatId, final byte[] globalTransactionId) {
     ...
     * @param other
     */
    public OracleAQXid(final Xid other) {
    ...
    private void calcHash() {
        byte[] hashBytes = OracleAQXid.toByteArray(this);
