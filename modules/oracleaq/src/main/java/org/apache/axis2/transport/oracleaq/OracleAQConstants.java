...
public class OracleAQConstants {
     ...
     * factory it should be using by a Parameter named OracleAQConstants.CONFAC_PARAM
     */
	...
	/** Cache the JMS connection, Session and Producer within a OracleAQConnectionFactory when sending */
